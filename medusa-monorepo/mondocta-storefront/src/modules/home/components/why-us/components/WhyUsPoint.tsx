    ...
    return ( 
            <div ref={TextRef} className="flex flex-col gap-16 sm:justify-around lg:justify-normal lg:flex-row mx-8 h-[90vh] opacity-0">
                <div className="flex flex-col lg:h-full lg:pt-10 sm:justify-between pt-8 sm:pt-4  sm:gap-8 md:gap-10">
                    ...
                    <h2 className="max-w-[90%] lg:pb-28 ml-2 text-2xl sm:text-3xl md:text-5xl lg:text-7xl">{title}</h2>
                </div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 justify-center ">
                        { point1 &&
                            <div className="flex flex-col gap-2 sm:gap-4">
                                ...
                                <p className="lg:max-w-[20vw] md:text-xl lg:text">{point1}</p>
                            </div>
                        }
                        { point2 &&  
                            <div className="flex flex-col gap-2 sm:gap-4">
                                <Image src="/person.svg" className="w-[30px] sm:w-[50px] h-[30px] sm:h-[50px] " width={50} height={50} alt={""} />
                                <p className="lg:max-w-[20vw] md:text-xl lg:text">{point2}</p>
                            </div>
                        }
                    </div> 
