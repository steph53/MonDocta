...
const AccountLayout: React.FC = ({ children }) => {
  ...
  if (retrievingCustomer || !customer) {
    return (
      <div className="flex items-center justify-center w-full min-h-[100vh] h-full text-gray-900">
        <Loading />
      </div>
    )
  }
  ...
  return (
    <div className="flex-1 flex small:py-12 small:bg-gray-50 min-h-[100vh]">
